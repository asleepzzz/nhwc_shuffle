                ...
                stage('Hip clang debug COMGR') {
                    ...
                    environment{
                        cmd = """
                            ...
                            MIOPEN_COMPILE_PARALLEL_LEVEL=1 CTEST_PARALLEL_LEVEL=1 MIOPEN_DEBUG_IMPLICIT_GEMM_NON_XDLOPS_INLINE_ASM=0 MIOPEN_CONV_PRECISE_ROCBLAS_TIMING=0 make -j\$(nproc) check
                        """
